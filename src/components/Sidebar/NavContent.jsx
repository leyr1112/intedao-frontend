...
import { ReactComponent as InteIcon } from "../../assets/icons/inte-nav-header.svg";
      ...
      <Box className="dapp-sidebar-inner" display="flex" justifyContent="space-between" flexDirection="column">
        <div className="dapp-menu-top">
          <Box className="branding-header">
            <Link href="https://app.intedao.com" target="_blank">
              <SvgIcon
                color="primary"
                component={InteIcon}
              ...
              />
              <div className="wallet-link f-32">InteDao</div>
            </Link>
            {address && (
