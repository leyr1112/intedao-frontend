...
import { ReactComponent as InteImg } from "../assets/tokens/INTE.svg";
import { ReactComponent as SInteImg } from "../assets/tokens/SINTE.svg";

import { Inte_usdt } from "./AllBonds";
...
export async function getMarketPrice({ networkID, provider }: IBaseAsyncThunk) {
  const Inte_usdt_address = Inte_usdt.getAddressForReserve(networkID);
  const pairContract = new ethers.Contract(Inte_usdt_address, PairContract, provider);
...
export async function getTokenPrice(tokenId = "inte-dao") {
